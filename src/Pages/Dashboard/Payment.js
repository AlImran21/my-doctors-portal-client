...
const Payment = () => {
    const { id } = useParams();
    const url = `https://gentle-retreat-95722.herokuapp.com/booking/${id}`;
    ...
    return (
        <div>
            <div class="card w-50 max-w-md bg-base-100 shadow-xl m-8">
                <div class="card-body">
            ...
            <div class="card flex-shrink-0 w-50 max-w-md shadow-2xl bg-base-100 m-8">
                <div class="card-body">
